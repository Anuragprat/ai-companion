...
const formSchema = z.object({
  ...
  description: z.string().min(1, {
    message: "Cannot generate without the description",
  }),
  ...
  src: z.string().min(1, {
    message: "Is your Companion Mr.X ?",
  }),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is how your AI Comapnion will be named
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    Short Description for your AI Comapnion
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
